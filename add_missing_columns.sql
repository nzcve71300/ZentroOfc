...
-- Run this in pgAdmin 4 to add the missing columns
...
-- Add missing columns to economy table (if needed)
-- The economy table should already have the correct structure
