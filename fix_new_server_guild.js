...
async function fixNewServerGuild() {
  try {
    console.log('🔧 Fixing new server guild association...');
    ...
    // Ask which guild to associate with (for now, use the first one)
    const targetGuild = guilds[0];
    console.log(`\n📋 Step 3: Associating with guild: ${targetGuild.name} (ID: ${targetGuild.id})`);
