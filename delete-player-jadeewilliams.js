...
async function deletePlayerRecords() {
  ...
  try {
    console.log('🗑️ Starting complete deletion of all data for player: jadeewilliams');
    console.log('============================================================');

    // First, find all player records with this name
    console.log('🔍 Searching for player records with name: jadeewilliams');
    ...
    if (playerRecords.length === 0) {
      console.log('❌ No player records found for jadeewilliams');
      return;
    }
    ...
    console.log('============================================================');
    console.log('🎉 Successfully deleted all records for player: jadeewilliams');
