...
console.log('🔧 Fixing autocomplete for ALL commands...');

// The working autocomplete function
  ...
  if (fs.existsSync(filePath)) {
    try {
      ...
      if (oldPattern.test(content)) {
        content = content.replace(oldPattern, newAutocomplete);
...
console.log(`✅ All commands now have working server autocomplete!`);
