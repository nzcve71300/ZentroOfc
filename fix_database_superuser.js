...
// Connect as the PostgreSQL superuser (postgres)
const pool = new Pool({
  host: process.env.DB_HOST || 'localhost',
  port: process.env.DB_PORT || 5432,
  database: process.env.DB_NAME || 'zentro_bot',
  user: 'postgres', // Connect as superuser
  password: 'admin' // Default PostgreSQL password - change this if you set a different password
});
...
async function fixDatabase() {
  ...
  try {
    console.log('Starting database migration as superuser...');
