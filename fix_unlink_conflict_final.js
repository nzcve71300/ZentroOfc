...
// Write the clean content to the unlink.js file
...
try {
  ...
  console.log('✅ All debugging and null safety fixes applied');
  console.log('✅ No more merge conflicts or syntax errors');
} catch (error) {
