  ...
  try {
    ...
    if (existingServers.length > 0) {
      ...
      const [result] = await pool.query(
        ...
        [guildRecord.id, serverDetails.nickname, serverDetails.ip, serverDetails.port, serverDetails.rcon_password]
      );
      console.log(`✅ Added server: ${serverDetails.nickname} with ID: ${result.insertId}`);
    }
