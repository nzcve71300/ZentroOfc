            ...
            <div className="space-y-6">
              ...
              <Card className="gaming-card border-orange-500 hover:border-orange-400 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure server settings and features
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <p className="text-sm text-muted-foreground">
                      Manage economy, teleports, events, systems, positions, and miscellaneous settings for your server.
                    </p>
                    <Button 
                      onClick={() => navigate('/server-configs')}
